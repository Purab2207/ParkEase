      ...
      <div className="max-w-md mx-auto min-h-[100dvh] bg-gray-50 flex flex-col items-center px-4 py-6 gap-5 sm:shadow-2xl">
        ...
        <div className="w-full grid grid-cols-3 gap-3">
          {['ola', 'uber', 'rapido'].map(p => (
            <CabProviderCard key={p} provider={p} availability={VENUE_DATA.cabAvailability[p]} dropZoneLat={VENUE_DATA.dropZoneLat} dropZoneLng={VENUE_DATA.dropZoneLng} dropZoneName={VENUE_DATA.dropZoneName} onTap={onRedirectTap} />
          ))}
        </div>
