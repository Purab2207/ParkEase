...
const ConfirmationHeader = ({ bookingId }) => (
  <div className="w-full flex flex-col items-center gap-2 pt-2 pb-1">
    <div className="w-16 h-16 bg-green-900/60 border border-green-700 rounded-full flex items-center justify-center">
      <CheckCircleIcon />
    </div>
...
const BookingSummaryCard = ({ booking }) => (
  <div className="w-full bg-gray-900 border border-gray-700 rounded-2xl px-5 py-4 flex flex-col gap-3">
    {/* Event */}
    <div className="flex flex-col gap-0.5 pb-3 border-b border-gray-800">
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="flex flex-col">
        <span className="text-sm font-bold text-white">Bay {booking.bayPillarCode}</span>
    ...
    <div className="flex items-center justify-between pt-2 border-t border-gray-800">
      ...
      <span className="text-sm font-bold text-white">₹{booking.consumerPrice} via UPI</span>
    </div>
  </div>
);
...
const WhatsAppShareBlock = ({ booking, groupSize, splitAmount }) => {
  ...
  return (
    <div className="w-full flex flex-col gap-3">
      ...
      <div className="w-full bg-gray-900 border border-gray-700 rounded-xl px-4 py-3">
    ...
    <div className="w-full flex flex-col gap-3">
      ...
      <div className="w-full bg-gray-900 border border-gray-800 rounded-xl px-4 py-3 flex flex-col gap-3">
        <div className="flex items-center justify-between">
          <span className="text-sm text-gray-300">Split ₹{consumerPrice} with</span>
          <div className="flex items-center gap-3">
            <button
        ...
        {groupSize > 1 && (
          <div className="flex items-center justify-between">
            ...
            <span className="text-lg font-bold text-green-400">₹{splitAmount}</span>
          </div>
        )}
      </div>
      {groupSize > 1 && (
        <button
          ...
          className="w-full bg-gray-800 hover:bg-gray-700 border border-gray-600 text-white font-semibold text-sm rounded-2xl py-3 flex items-center justify-center gap-2 active:scale-95 transition-all"
        >
...
const DepartureNudgeCard = ({ departureTime, bayPillarCode }) => (
  <div className="w-full bg-amber-950 border border-amber-800 rounded-xl px-4 py-3 flex items-start gap-3">
    ...
    <div className="flex flex-col gap-0.5">
      ...
      <span className="text-xs text-gray-500 mt-1">Push notification — sent 90 mins before event</span>
    </div>
  </div>
);
...
const DirectionsButton = ({ gateName, venueName }) => (
  <button className="w-full bg-blue-950 border border-blue-800 hover:bg-blue-900 text-blue-300 font-semibold text-sm rounded-2xl py-3 flex items-center justify-center gap-2 active:scale-95 transition-all">
    <MapPinIcon />
...
export default function BookingConfirmationScreen({ bookingId = 'pe-2026-karan-aujla-b18' }) {
  ...
  return (
    <div className="min-h-[100dvh] bg-gray-950 font-sans sm:bg-gray-900">
      <div className="max-w-md mx-auto min-h-[100dvh] bg-gray-950 flex flex-col px-4 py-6 gap-5 sm:shadow-2xl">
