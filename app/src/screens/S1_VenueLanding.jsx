...
// PRD feature #18 — navigation routing to parking entry gate
const GetDirectionsButton = ({ lat, lng, gateName, venueName }) => {
  ...
  return (
    <div className="min-h-[100dvh] bg-gray-50 font-sans sm:bg-gray-50">
      <div className="max-w-md mx-auto min-h-[100dvh] bg-gray-50 flex flex-col px-4 py-5 gap-4 sm:shadow-2xl">
        ...
        {/* PRD feature #18 — directions to parking gate */}
        <GetDirectionsButton
          lat={venue.parkingLat}
          lng={venue.parkingLng}
          gateName={venue.gateName}
          venueName={venue.venue}
        />
