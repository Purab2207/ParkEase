...
const PDFReportButton = ({ data }) => {
  ...
  const handleDownload = () => {
    ...
    setTimeout(() => {
      ...
      // Render the report as a real PDF — monospace font preserves the ASCII layout.
      ...
      doc.save(`ParkEase_Compliance_${data.eventName.replace(/\s+/g, '_')}_${data.date.replace(/,?\s+/g, '_')}.pdf`);
