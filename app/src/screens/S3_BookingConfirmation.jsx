    ...
    <div className="flex flex-col items-center gap-3">
      ...
      <div className="w-full flex flex-col items-center gap-2 mt-2">
        <button
          disabled
          title="Coming soon"
          className="w-full flex items-center justify-center gap-2 bg-gray-900 text-white rounded-2xl py-3 opacity-50 cursor-not-allowed"
        >
        ...
        <p className="text-xs text-gray-400">Google Wallet coming soon</p>
      </div>
    </div>
  );
};
  ...
  return (
    <div className="min-h-[100dvh] bg-gray-50 font-sans sm:bg-gray-50">
      <div className="max-w-md mx-auto min-h-[100dvh] bg-gray-50 flex flex-col px-4 py-6 gap-5 pb-20 sm:shadow-2xl">
        ...
        {/* Navigation to retention screen */}
