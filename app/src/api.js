...
export const FALLBACK_EVENTS = {
  ...
  'arijit-singh-dy-patil-2026': {
    ...
    lots: [
      { id: 'a', name: 'Lot A', total: 60, distance_m: 150, gate_name: 'Gate 1' },
      { id: 'b', name: 'Lot B', total: 60, distance_m: 250, gate_name: 'Gate 3' },
      { id: 'c', name: 'Lot C', total: 60, distance_m: 380, gate_name: 'Gate 5' },
    ],
  ...
  'coldplay-nms-2026': {
    ...
    lots: [
      { id: 'a', name: 'Lot A', total: 60, distance_m: 200, gate_name: 'Gate A' },
      { id: 'b', name: 'Lot B', total: 60, distance_m: 300, gate_name: 'Gate C' },
      { id: 'c', name: 'Lot C', total: 60, distance_m: 420, gate_name: 'Gate D' },
    ],
  ...
  'diljit-dosanjh-pca-2026': {
    ...
    lots: [
      { id: 'a', name: 'Lot A', total: 60, distance_m: 160, gate_name: 'Gate 3' },
      { id: 'b', name: 'Lot B', total: 60, distance_m: 260, gate_name: 'Gate 5' },
      { id: 'c', name: 'Lot C', total: 60, distance_m: 380, gate_name: 'Gate 7' },
    ],
  ...
  'csk-kkr-ipl-2026': {
    ...
    entry_windows: ['4:00–5:30 PM', '5:30–7:00 PM'],
    lots: [
      { id: 'a', name: 'Lot A', total: 60, distance_m: 140, gate_name: 'Gate A' },
      { id: 'b', name: 'Lot B', total: 60, distance_m: 230, gate_name: 'Gate B' },
      { id: 'c', name: 'Lot C', total: 60, distance_m: 340, gate_name: 'Gate C' },
    ],
  ...
  'mi-srh-ipl-2026': {
    ...
    entry_windows: ['4:30–6:00 PM', '6:00–7:30 PM'],
    lots: [
      { id: 'a', name: 'Lot A', total: 60, distance_m: 120, gate_name: 'Gate 1' },
      { id: 'b', name: 'Lot B', total: 60, distance_m: 210, gate_name: 'Gate 3' },
      { id: 'c', name: 'Lot C', total: 60, distance_m: 320, gate_name: 'Gate 5' },
    ],
    prohibited_items: ['Professional cameras / DSLR', 'Outside food & beverages', 'Laser pointers', 'Banners larger than A4'],
    amenities: ['Pillar-mapped bays', 'QR entry enforcement', 'Pre-assigned bay number'],
    booking_count: 45,
